 ...
 * @UpdateRemark: 填写更新说明
 */
public class SpringViewNewHeader extends BaseHeader {
    ...
    public SpringViewNewHeader(Context context){
        this(context, R.drawable.springview_new_progress,R.drawable.arrow);
    }

    public SpringViewNewHeader(Context context,int rotationSrc,int arrowSrc){
    ...
    public View getView(LayoutInflater inflater, ViewGroup viewGroup) {
        View view = inflater.inflate(R.layout.springview_style_header, viewGroup, true);
