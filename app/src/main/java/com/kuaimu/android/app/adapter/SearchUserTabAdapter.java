...
import com.kuaimu.android.app.databinding.ItemSearchUserTabLayoutBinding;
...
public class SearchUserTabAdapter extends BaseRecyclerAdapter<NavData.DataBean, ItemSearchUserTabLayoutBinding> {
    ...
    @Override
    protected void onBindItem(final ItemSearchUserTabLayoutBinding binding, final NavData.DataBean dataBean, final int position) {
