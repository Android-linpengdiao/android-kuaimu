...
import com.kuaimu.android.app.databinding.ActivityResetPasswordBinding;
...
public class ResetPasswordActivity extends BaseActivity{
    ...
    private ActivityResetPasswordBinding forgotPasswordBinding;
    private CountDownTimer timer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        forgotPasswordBinding = DataBindingUtil.setContentView(this, R.layout.activity_reset_password);
    ...
    private void createForgotAuthCode() {
        ...
        if (phone.length() < 11) {
            ToastUtils.showShort(ResetPasswordActivity.this, "手机号码不正确");
            return;
        }
            ...
            public void onResponse(String response, int id) {
                try {
                    ...
                    if (json.optInt("code") == 200) {
                        ...
                        ToastUtils.showShort(ResetPasswordActivity.this, "验证码发送成功");
                    } else {
    ...
    private void updatePasswordAndLogin() {
        ...
        if (!password.equals(confirmPassword)) {
            ToastUtils.showShort(ResetPasswordActivity.this, "密码不一致");
            return;
        }
        SendRequest.forgetPassword(phone, authCode, password, password, new StringCallback() {
            ...
            public void onResponse(String response, int id) {
                try {
                    JSONObject json = new JSONObject(response);
                    if (json.optInt("code") == 200) {
                        ToastUtils.showShort(ResetPasswordActivity.this, "修改密码成功");
                        finish();
                    } else {
                        String msg = json.optString("msg");
                        ToastUtils.showShort(getApplication(), msg);
