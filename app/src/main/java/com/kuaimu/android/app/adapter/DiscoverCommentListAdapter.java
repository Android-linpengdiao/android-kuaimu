...
public class DiscoverCommentListAdapter extends BaseRecyclerAdapter<DiscoverCommentData.DataBeanX.CommentBean.DataBean, ItemCommentListLayoutBinding> {
    ...
    public DiscoverCommentListAdapter(Context context) {
        super(context);
    }
    ...
    @Override
    protected void onBindItem(final ItemCommentListLayoutBinding binding, final DiscoverCommentData.DataBeanX.CommentBean.DataBean dataBean, final int position) {
