...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jCameraView.setTip("视频时长" + getIntent().getIntExtra(MAX_TIME, 30) + "S以内");
        jCameraView.setMediaQuality(JCameraView.MEDIA_QUALITY_MIDDLE);
        jCameraView.setDuration(getIntent().getIntExtra(MAX_TIME, 30) * 1000);
        jCameraView.setMinDuration(getIntent().getIntExtra(MIN_TIME, 1) * 1000);
        ...
        jCameraView.setLeftClickListener(new ClickListener() {
            ...
            public void onClick() {
                try {
                    ...
                    intent.putExtra("maxTime", getIntent().getIntExtra(MAX_TIME, 30));
