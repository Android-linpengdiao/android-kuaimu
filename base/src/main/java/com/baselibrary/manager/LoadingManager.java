...
public class LoadingManager {
    ...
    public static void showProgress(final Activity activity, final String progress,boolean isButtom,Listener listener) {
        progressView = null;
        progressView = new ProgressView(activity, R.style.LoadingDialogTheme,isButtom,listener);
        activity.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                progressView.show();
