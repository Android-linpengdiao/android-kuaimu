...
public class DialogManager {
    ...
    public static void showEditorInfoDialog(Activity act, final Listener listener) {
        final AlertDialog dialog = new AlertDialog.Builder(act, AlertDialog.THEME_HOLO_DARK).create();
        dialog.setCancelable(true);
        dialog.show();
        Window window = dialog.getWindow();
        ...
        TextView tvTitle = window.findViewById(R.id.title);
        TextView tvContent = window.findViewById(R.id.content);
        ImageView closeView = window.findViewById(R.id.closeView);
        TextView confirmView = window.findViewById(R.id.confirmView);
